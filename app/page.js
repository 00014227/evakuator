    ...
    <main className="flex min-h-screen flex-col bg-[#404040]">
      <section className=" lg:h-screen" id="hero">
        ...
        <div className=" lg:flex items-center 2xl:py-8 py-5 lg:px-24 px-10 justify-between  lg:border-b-0 border-b border-white space-y-4">
          ...
          <div className="flex items-center lg:gap-4 gap-2 ml-4 ">
            ...
            <Image src={Time} alt='time' className=" lg:w-[2.5rem] w-[1.8rem] h-[1.9rem] lg:h-[2.6rem]" />
          ...
          <div className="flex lg:gap-4 gap-2 items-center ml-10">
            <Image src={Phone} alt='phone' className=" lg:w-[2.5rem] w-[1.8rem] h-[1.9rem] lg:h-[2.6rem]" />
      ...
      <section id="price" className="flex flex-col justify-center  pt-12 px-10 pb-8">
        ...
        <div className="lg:flex md:grid grid-cols-2 gap-5 mx-auto justify-between mt-12 lg:space-y-0 space-y-4">
          ...
          <div className=" max-w-[300px] bg-white flex flex-col justify-center items-center border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">

            <Image className="rounded-t-lg mt-10" src={Bike} alt="bike" />
            ...
            <div className="p-5 space-y-7">
              ...
              <a href="tel:+998950555555" className="inline-flex items-center ml-[4rem]  px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Заказать
          ...
          <div className=" max-w-[300px] flex flex-col justify-center items-center bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-5 space-y-7">
              ...
              <a href="tel:+998950555555" className="inline-flex items-center ml-[5rem]    px-3 py-2 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Заказать
      ...
      <section className=" bg-white ">
        <div className="flex flex-col justify-center lg:px-20 px-4 items-center pt-10 pb-16">
          ...
          <div className="flex lg:gap-[3rem] gap-[1.5rem]  items-center justify-center">
            <Image src={Galochka} alt='galochka' className=' w-[3.5rem] h-[3.5rem]' />
      ...
      <footer className=" py-10 lg:px-20 px-10">
        <div className="lg:flex justify-between space-y-4">
          <div className="flex gap-5 items-center">
            <Image className=" w-[2.5rem] h-[3rem]" src={Coins} alt='coins' />
